                        ...
                        <div class="card no-b">
                            <div class="card-body">
                                ...
                                <div class="card-title">
                                    <button type="button" class="btn btn-outline-danger" onclick="create_housing();">Add Housing</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" name="delete" onclick="delete_housing(this.value)">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_housing')?>",
                    "type": "POST"
                },
        ...
        function edit_housing(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/edit_housing')?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function get_data_delete_housing(id)
        {
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('main/create_housing')?>";
            } else {
                url = "<?php echo site_url('main/update_housing')?>";
            }
        ...
        function delete_housing(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/delete_housing')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
