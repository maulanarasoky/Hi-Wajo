                        ...
                        <div class="card no-b">
                            <div class="card-body">
                                ...
                                <div class="card-title">
                                    <button type="button" class="btn btn-outline-danger" onclick="create_cafe();">Add Cafe</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" name="delete" onclick="delete_cafe(this.value)">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_cafe')?>",
                    "type": "POST"
                },
        ...
        function edit_cafe(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/edit_cafe')?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function get_data_delete_cafe(id)
        {
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('main/create_cafe')?>";
            } else {
                url = "<?php echo site_url('main/update_cafe')?>";
            }
        ...
        function delete_cafe(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/delete_cafe')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
