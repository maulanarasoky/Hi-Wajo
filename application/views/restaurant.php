                ...
                <div class="card no-b">
                    <div class="card-body">
                        ...
                        <div class="card-title">
                            <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#newsModal">Add Restaurant</button>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <form method="POST" id="add_news">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" class="form-control" name="restaurant_phone_number" required>
                                    <label class="form-label">Phone Number</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea name="restaurant_description" cols="30" rows="5" class="form-control no-resize" required></textarea>
...
<!--Footer
 -- You can inject foot partial or if you want to add scripts after
 -- app.js you can do like following
 -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "columns" : [
                {"data" : "kode_restaurant", width:100},
                {"data" : "nama_restaurant", width:100},
                {"data" : "alamat_restaurant", width:100},
                {"data" : "nomor_restaurant", width:100},
                {"data" : "deskripsi_restaurant", width:100},
                {"data" : "edit"},
                {"data" : "delete"}
            ],
        });
