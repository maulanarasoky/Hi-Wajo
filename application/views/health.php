                        ...
                        <div class="card no-b">
                            <div class="card-body">
                                ...
                                <div class="card-title">
                                    <button type="button" class="btn btn-outline-danger" onclick="create_health();">Add Health</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" name="delete" onclick="delete_health(this.value)">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_health')?>",
                    "type": "POST"
                },
        ...
        function edit_health(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/edit_health')?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function get_data_delete_health(id)
        {
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('main/create_health')?>";
            } else {
                url = "<?php echo site_url('main/update_health')?>";
            }
        ...
        function delete_health(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/delete_health')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
