                        ...
                        <div class="card no-b">
                            <div class="card-body">
                                ...
                                <div class="card-title">
                                    <button type="button" class="btn btn-outline-danger" onclick="create_tourism();">Add Tourism</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" name="delete" onclick="delete_tourism(this.value)">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_tourism')?>",
                    "type": "POST"
                },
        ...
        function edit_tourism(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/edit_tourism')?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function get_data_delete_tourism(id)
        {
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('main/create_tourism')?>";
            } else {
                url = "<?php echo site_url('main/update_tourism')?>";
            }
        ...
        function delete_tourism(id)
        {
            var table = $('#table').DataTable();
                    // ajax delete data to database
            $.ajax({
                url : "<?php echo site_url('main/delete_tourism')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
