                    ...
                    <div class="row">
                        <div class="col">
                            <h3 class="my-3">
                                ...
                                Bank and Finance<span class="s-14"></span>
                            </h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card no-b">
                            <div class="card-body">
                                ...
                                <div class="card-title">
                                    <button type="button" class="btn btn-outline-danger" onclick="create_bank_finance();">Add Bank and Finance</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" name="delete" onclick="delete_bank_finance(this.value)">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_bank_finance')?>",
                    "type": "POST"
                },
        ...
        function edit_bank_finance(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/edit_bank_finance')?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function get_data_delete_bank_finance(id)
        {
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('main/create_bank_finance')?>";
            } else {
                url = "<?php echo site_url('main/update_bank_finance')?>";
            }
        ...
        function delete_bank_finance(id)
        {
            var table = $('#table').DataTable();
                    // ajax delete data to database
            $.ajax({
                url : "<?php echo site_url('main/delete_bank_finance')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
