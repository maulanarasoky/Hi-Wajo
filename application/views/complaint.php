                    ...
                    <div class="row">
                        <div class="col">
                            <h3 class="my-3">
                                ...
                                Complaint<span class="s-14"></span>
                            </h3>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_complaint')?>",
                    "type": "POST"
                },
        ...
        function edit_complaint_confirm(id)
        {
        
            //Ajax Load data from ajax
            $.ajax({
                url : "<?php echo site_url('main/edit_complaint_confirm')?>/" + id,
                type: "POST",
                dataType: "JSON",
        ...
        function edit_status_complaint(id)
        {   save_method = 'update_status';
        
            //Ajax Load data from ajax
            $.ajax({
                url : "<?php echo site_url('main/get_edit_status_complaint')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
        ...
        function edit_finish_complaint(id)
        {   save_method = 'update_finish';
        
            //Ajax Load data from ajax
            $.ajax({
                url : "<?php echo site_url('main/get_edit_finish_complaint')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
        ...
        function get_data_delete_complaint(id)
        {
        
            //Ajax Load data from ajax
            $.ajax({
                url : "<?php echo site_url('main/edit_complaint')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
        ...
        function delete_complaint(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/delete_complaint')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
