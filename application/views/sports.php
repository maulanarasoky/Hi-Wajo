                        ...
                        <div class="card no-b">
                            <div class="card-body">
                                ...
                                <div class="card-title">
                                    <button type="button" class="btn btn-outline-danger" onclick="create_sports();">Add Sports</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-ok" name="delete" onclick="delete_sports(this.value)">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('main/read_sports')?>",
                    "type": "POST"
                },
        ...
        function edit_sports(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/edit_sports')?>/" + id,
                type: "GET",
                dataType: "JSON",
        ...
        function get_data_delete_sports(id)
        {
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('main/create_sports')?>";
            } else {
                url = "<?php echo site_url('main/update_sports')?>";
            }
        ...
        function delete_sports(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('main/delete_sports')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
